...
export const api = {
  ...
  createProfile: (name: string, iconBase64?: string, tags?: string): Promise<Profile> => 
    invoke('create_profile', { name, iconBase64, tags }),
  
  updateProfile: (id: string, name?: string, iconBase64?: string, tags?: string): Promise<boolean> => 
    invoke('update_profile', { id, name, iconBase64, tags }),
